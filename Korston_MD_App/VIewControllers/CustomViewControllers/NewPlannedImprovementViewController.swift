//
//  NewPlannedImprovementViewController.swift
//  Korston_MD_App
//
...
class NewPlannedImprovementViewController: UIViewController {
    //MARK: - Outlets
    ...
    @IBAction func addButtonDidTap(_ sender: Any) {
        ...
        firestore.addImprovementFor(type: .plannedJobs, jobName: jobName, contractor: contractor, date: date, forDistrict: districtId, forCounty: countyId, forStreet: streetId, forHouse: houseId)
